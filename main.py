...
root=Tk()
root.title("Notepad Text Editor Python")

savebtn=Button(root,command=saveDoc,text="Save")
savebtn.grid(row=1,column=0)
savebtn.config(font=('arial',14,'bold'),bg="#008CBA",fg="white")

fontbtn=Menubutton(root,text="Font")
fontbtn.config(font=('arial',14,'bold'),bg="#008CBA",fg="white")
...
boldbtn.config(font=('arial',14,'bold'),bg="#008CBA",fg="white")
